...
STORAGE
The raw CSV file is stored in Google Cloud Storage (GCS). I created a dedicated bucket with a folder structure that separates raw, staging, and profiling layers. A Python script uploads the raw CSV from NYC Checkbook into to the GCS bucket. This structure supports a scalable pipeline and mirrors common industry data lake patterns.

Data Sample: https://console.cloud.google.com/bigquery?ws=!1m5!1m4!4m3!1snyc-gov-spending!2snyc_spending!3sfact_spending
